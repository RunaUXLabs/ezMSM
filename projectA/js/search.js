...
async function movieSearchFnc(movieName) {
  ...
  let url = `https://runauxlabs.herokuapp.com/https://api.koreafilm.or.kr/openapi-data2/wisenut/search_api/search_json2.jsp${moviePosterValue.key}${moviePosterValue.collection}${moviePosterValue.title}${moviePosterValue.sort}`;
